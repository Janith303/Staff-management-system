    ...
    <header class="d-flex justify-content-end align-items-center" style="background-color: #839492; color: #fff; padding: 10px;">
        <nav>
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="btn custom-btn me-4" href="managepri.jsp">Manage Event</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-md-8 form-container">
                ...
                <form action="inserte" method="post">
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn btn-submit" value="insert">Add Event</button>
                        <a href="addevent.jsp" class="btn btn-cancel">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
