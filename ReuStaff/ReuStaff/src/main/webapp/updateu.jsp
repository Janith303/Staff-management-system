	...
	<header class="d-flex justify-content-end align-items-center"
		...
		<nav>
			<ul class="nav">
				...
				<li class="nav-item"><a class="btn custom-btn me-4"
					href="manageu.jsp">Manage Users</a></li>
				<!-- <li class="nav-item">
				...
				<li class="nav-item"><a class="btn custom-btn me-4" href="logout">Log out</a></li>
			</ul>
		</nav>
	</header>
			...
			<div class="col-md-8 form-container">
				...
				<form action="updateuser" method="post">
					<div class="mb-3 form-group">
						...
						<input type="text" class="form-control" id="is" name="id" value='${ptss.memberid}' readonly>
					</div>
					<div class="mb-3 form-group">
						<label for="address">name</label>
						 <input type="text"class="form-control" id="name" name="name" value='${ptss.name}'>
					</div>
					<div class="mb-3 form-group">
						<label for="email">Email</label> 
						<input type="email"class="form-control" id="mail" name="mail" value='${ptss.mail}'>
					</div>
					<div class="mb-3 form-group">
						<label for="userType">User Position</label> 
						<select class="form-control" id="type" name="type">
							<option value='${ptss.type}'>${ptss.type}</option>
							<option value="Admin">Admin</option>
							<option value="Teacher">Teacher</option>
							<option value="principal">principal</option>
							<option value="Payroll Office">Payroll Officer</option>
						</select>
					</div>
