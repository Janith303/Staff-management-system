...
%>
	...
	<header class="d-flex justify-content-end align-items-center"
		...
		<nav>
			<ul class="nav">
				...
				<li class="nav-item"><a class="btn custom-btn me-4" href="manageu.jsp">Manage
						Users</a></li>
				<!-- <li class="nav-item">
	...
	<div class="container search-bar-section">
		<div class="row">
			...
			<div class="col-auto">
				<form>
					<a href="insert.jsp" class="btn btn-primary custom-btn-lg mx-1">Add New Users</a>
				</form>
			</div>
			...
			<div class="col-auto">
				<form action="adduser" method="post" style="display: inline;">
					<button type="submit" class="btn btn-success">View User Details</button>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="row w-75 mx-auto">
		<h2 class="he text-center">Members List</h2>
		...
		<table class="table mt-2">
			...
			<tbody>
				<c:forEach var="ptss" items="${pts}">
					<tr>
						<td><c:out value='${ptss.memberid}' /></td>
						<td><c:out value='${ptss.name}' /></td>
						<td><c:out value='${ptss.mail}' /></td>
						<td><c:out value='${ptss.type}' /></td>
						<td>
							<form action="updateu" method="post" style="display: inline;">
								<a href="updateu?memberid=<c:out value='${ptss.memberid }'/>"
									class="btn btn-success">Edit</a>
							</form>
							<form action="deletu" method="post" style="display: inline;" id="com">
								<input type="hidden" name="memberid" value="'${ptss.memberid}'" >
